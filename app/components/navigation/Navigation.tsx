  ...
  return (
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between mb-4">
      <div className="flex items-center overflow-x-auto mb-4 md:mb-0 md:overflow-x-visible">
        <Link
          href="/"
          className="flex items-center gap-2 md:gap-4 text-color-BE963C hover:bg-color-222036 rounded-lg text-xl font-normal px-2 py-2 md:px-4 md:py-4 whitespace-nowrap"
        >
          <svg
            width="36"
            height="36"
